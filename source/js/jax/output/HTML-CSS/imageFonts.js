  ...
  b.Register.LoadHook(c.fontDir + '/fontdata.js', function() {
    c.Augment({
      ...
      handleImg: function(t, i, r, h, u) {
        ...
        if (
          p == this.imgEmWidth.length - 1 &&
          (this.em * t.scale * m) / this.imgEmWidth[p] > 1.1
        ) {
        ...
        var o = r[5].img[p];
        var g = {
          width: Math.floor(o[0] / m + 0.5) + 'px',
          height: Math.floor(o[1] / m + 0.5) + 'px'
        };
        if (o[2]) {
      ...
      initImg: function(j) {
        ...
        if (
          h &&
          this.imgEmWidth[h] - this.em > this.em - this.imgEmWidth[h - 1]
        ) {
          h--;
        }
        ...
        c.Augment({
          ...
          imgBrowserZoom: function() {
            ...
            var h = this.imgDoc.clientHeight,
              i = Math.floor((15 * h) / window.innerHeight);
