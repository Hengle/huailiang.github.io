  ...
  MML.menclose.Augment({
          ...
          case MML.NOTATION.ROUNDEDBOX:
            if (HTMLCSS.useVML) {
              ...
              this.HTMLvmlElement(vml, "shape", {
                style: {
                  width: this.HTMLpx(W - 2 * t), height: this.HTMLpx(H + D - 2 * t),
          ...
          case MML.NOTATION.LONGDIV:
            if (HTMLCSS.useVML) {
              ...
              this.HTMLvmlElement(vml, "arc", {
                style: {
                  width: this.HTMLpx(2 * p), height: this.HTMLpx(H + D - 2 * t),
    ...
    HTMLhandleColor: function (span) {
      ...
      if (frame) {
        ...
        if (values.mathbackground && values.mathbackground !== MML.COLOR.TRANSPARENT) { frame.style.backgroundColor = values.mathbackground }
