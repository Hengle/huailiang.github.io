...
(function(q, e, D) {
    ...
    FONTDATA: {
      ...
      DELIMITERS: {
        ...
        8722: {
          dir: r,
          HW: [],
          stretch: { rep: [8722, v, 0, 0, 0, -0.224, -0.224] }
        },
        ...
        9136: {
          dir: d,
          HW: [[0.607, u, null, 9127]],
          stretch: { top: [9127, u], ext: [9130, u], bot: [9133, u] }
        },
        9137: {
          dir: d,
          HW: [[0.607, u, null, 9131]],
  ...
  MathJax.Hub.Register.LoadHook(
    ...
    function() {
      var F;
      for (F = 8747; F <= 8749; F++) {
        q.FONTDATA.FONTS[m][F][2] -= 200;
        q.FONTDATA.FONTS[m][F][5] = { rfix: -200 };
      }
      for (F = 8750; F <= 8753; F++) {
        q.FONTDATA.FONTS[m][F][2] -= 150;
        q.FONTDATA.FONTS[m][F][5] = { rfix: -150 };
      }
    }
  );
