/*
 *  /MathJax/jax/output/SVG/fonts/Gyre-Pagella/fontdata.js
 *
...
(function(z, e, E, o) {
  ...
  var c = 'GyrePagellaMathJax_Alphabets',
    ...
    D = 'GyrePagellaMathJax_Operators',
    a = 'GyrePagellaMathJax_SansSerif',
    q = 'GyrePagellaMathJax_Script',
  ...
  z.Augment({
    FONTDATA: {
      ...
      DELIMITERS: {
        ...
        8720: j,
        8721: j,
        8722: { HW: [], stretch: { rep: [8722, v, 0, 0, 0, -0.27, -0.28] } },
  ...
  MathJax.Hub.Register.LoadHook(
    ...
    function() {
      var G;
      for (G = 8747; G <= 8749; G++) {
        z.FONTDATA.FONTS[m][G][2] -= 190;
      }
      for (G = 8750; G <= 8753; G++) {
        z.FONTDATA.FONTS[m][G][2] -= 100;
      }
    }
  );
