...
MathJax.Hub.Register.StartupHook('SVG Jax Ready', function() {
  ...
  a.mfenced.Augment({
    ...
    SVGmoveLine: function(l, n, q, h, s) {
      ...
      if (p === o && l.length > 1) {
        this.data[this.dataI[p]].SVGmoveSlice(
          l.slice(1),
          n.slice(1),
          q,
          h,
  ...
  a.msubsup.Augment({
    ...
    SVGmoveLine: function(j, k, n, i, p) {
      if (this.data[this.base]) {
        if (j.length > 1) {
          ...
          if (k.length <= 1) {
            this.data[this.base].SVGmove(n, i, p);
          } else {
            this.data[this.base].SVGmoveSlice(
              [],
              k.slice(1),
      ...
      if (k.length === 0) {
        var m = this.data[this.sup],
          h = this.data[this.sub],
          o = n.w,
          l;
        if (m) {
          l = m.SVGdata || {};
          n.Add(m.toSVG(), o + (l.dx || 0), l.dy);
        }
        if (h) {
          l = h.SVGdata || {};
          n.Add(h.toSVG(), o + (l.dx || 0), l.dy);
        }
      }
    }
  });
  ...
  a.mo.Augment({
    SVGbetterBreak: function(j, h) {
      ...
      if (
        (r.linebreakstyle === a.LINEBREAKSTYLE.AFTER &&
          r.texClass === a.TEXCLASS.OPEN) ||
