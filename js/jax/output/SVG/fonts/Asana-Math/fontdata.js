...
(function(z, e, E, o) {
  ...
  var c = 'AsanaMathJax_Alphabets',
    ...
    C = 'AsanaMathJax_Fraktur',
    h = 'AsanaMathJax_Latin',
    v = 'AsanaMathJax_Main',
    n = 'AsanaMathJax_Marks',
    x = 'AsanaMathJax_Misc',
    F = 'AsanaMathJax_Monospace',
    A = 'AsanaMathJax_NonUnicode',
    s = 'AsanaMathJax_Normal',
    D = 'AsanaMathJax_Operators',
    a = 'AsanaMathJax_SansSerif',
    q = 'AsanaMathJax_Script',
  ...
  z.Augment({
    FONTDATA: {
      ...
      DELIMITERS: {
        40: {
          dir: d,
          HW: [[941, v], [1471, m], [2041, l], [2552, k], [2615, k, 1.025]],
        ...
        45: { alias: 8722, dir: r },
        47: { alias: 8260, dir: r },
        61: { dir: r, HW: [[539, v]], stretch: { rep: [61, v] } },
        91: {
          dir: d,
          HW: [[910, v], [1476, m], [2045, l], [2556, k], [2615, k, 1.023]],
        ...
        123: {
          dir: d,
          HW: [[901, v], [1471, m], [2041, l], [2552, k], [2615, k, 1.025]],
          stretch: {
            bot: [9129, u],
            ext: [9130, u],
            mid: [9128, u],
        ...
        770: {
          dir: r,
          HW: [[312, v], [453, m], [633, l], [1055, k], [2017, i], [3026, g]]
        },
        771: {
          dir: r,
          HW: [[330, v], [701, m], [1053, l], [1403, k], [1865, i], [2797, g]]
        },
        773: {
          dir: r,
          HW: [[433, n], [511, m], [675, l], [1127, k]],
          stretch: { rep: [57345, f], right: [57345, f] }
        },
        774: t,
        780: {
          dir: r,
          HW: [[312, v], [737, m], [1105, l], [1474, k], [1960, i], [2940, g]]
        },
        818: {
          dir: r,
          HW: [[433, n], [511, m], [675, l], [1127, k]],
        ...
        8214: {
          dir: d,
          HW: [[885, v], [1275, m], [1555, l], [1897, k], [2315, i]],
        ...
        8719: { dir: d, HW: [[937, D], [1349, m], [1942, l], [2797, k]] },
        8720: j,
        8721: j,
        8722: {
          dir: r,
        ...
        8730: {
          dir: d,
          HW: [[1138, v], [1280, m], [1912, l], [2543, k], [3175, i]],
        ...
        8968: {
          dir: d,
          HW: [[885, v], [1470, m], [2041, l], [2552, k], [2615, k, 1.025]],
        ...
        9130: { dir: d, HW: [[688, u]], stretch: { ext: [9130, u] } },
        9135: { dir: r, HW: [[638, u]], stretch: { rep: [9135, u] } },
        ...
        10181: {
          dir: d,
          HW: [[910, u], [1020, m], [1531, l], [2041, k], [2552, i], [3063, g]]
        },
        10182: {
          dir: d,
          HW: [[910, u], [1020, m], [1531, l], [2041, k], [2552, i], [3063, g]]
  ...
  MathJax.Hub.Register.LoadHook(
    z.fontDir + '/Size6/Regular/Main.js',
    function() {
      var G;
      G = z.FONTDATA.DELIMITERS[9182].stretch.rep[0];
      z.FONTDATA.FONTS[f][G][0] += 100;
      z.FONTDATA.FONTS[f][G][1] += 100;
      G = z.FONTDATA.DELIMITERS[9183].stretch.rep[0];
      z.FONTDATA.FONTS[f][G][0] += 100;
      z.FONTDATA.FONTS[f][G][1] += 100;
    }
  );
  MathJax.Hub.Register.LoadHook(
    ...
    function() {
      var G;
      z.FONTDATA.FONTS[m][8747][2] -= 300;
      for (G = 8748; G <= 8755; G++) {
        z.FONTDATA.FONTS[m][G][2] -= 420;
      }
      for (G = 10764; G <= 10780; G++) {
        z.FONTDATA.FONTS[m][G][2] -= 420;
      }
    }
  );
