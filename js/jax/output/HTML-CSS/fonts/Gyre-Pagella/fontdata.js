...
(function(q, e, D) {
  ...
  var c = 'GyrePagellaMathJax_Alphabets',
    w = 'GyrePagellaMathJax_Arrows',
    y = 'GyrePagellaMathJax_DoubleStruck',
    B = 'GyrePagellaMathJax_Fraktur',
    h = 'GyrePagellaMathJax_Latin',
    v = 'GyrePagellaMathJax_Main',
    n = 'GyrePagellaMathJax_Marks',
    x = 'GyrePagellaMathJax_Misc',
    E = 'GyrePagellaMathJax_Monospace',
    z = 'GyrePagellaMathJax_NonUnicode',
    s = 'GyrePagellaMathJax_Normal',
    C = 'GyrePagellaMathJax_Operators',
    a = 'GyrePagellaMathJax_SansSerif',
    p = 'GyrePagellaMathJax_Script',
    b = 'GyrePagellaMathJax_Shapes',
    m = 'GyrePagellaMathJax_Size1',
    l = 'GyrePagellaMathJax_Size2',
    k = 'GyrePagellaMathJax_Size3',
    i = 'GyrePagellaMathJax_Size4',
    g = 'GyrePagellaMathJax_Size5',
    f = 'GyrePagellaMathJax_Size6',
    u = 'GyrePagellaMathJax_Symbols',
    o = 'GyrePagellaMathJax_Variants';
  var r = 'H',
    d = 'V',
    t = { load: 'extra', dir: r },
    j = { load: 'extra', dir: d };
  q.Augment({
    FONTDATA: {
      ...
      VARIANT: {
        ...
        '-tex-oldstyle': { fonts: [v, s, E, h, c, n, w, C, u, b, x, o, z, m] },
      ...
      DELIMITERS: {
        ...
        8722: {
          dir: r,
          HW: [],
          stretch: { rep: [8722, v, 0, 0, 0, -0.27, -0.28] }
        },
        ...
        9130: { dir: d, HW: [[0.596, u]], stretch: { ext: [9130, u] } },
        9135: { alias: 8722, dir: r },
        9136: {
          dir: d,
          HW: [[0.616, u, null, 9127]],
          stretch: { top: [9127, u], ext: [9130, u], bot: [9133, u] }
        },
        9137: {
          dir: d,
          HW: [[0.616, u, null, 9131]],
  ...
  MathJax.Hub.Register.LoadHook(
    ...
    function() {
      var F;
      for (F = 8747; F <= 8749; F++) {
        q.FONTDATA.FONTS[m][F][2] -= 190;
        q.FONTDATA.FONTS[m][F][5] = { rfix: -190 };
      }
      for (F = 8750; F <= 8753; F++) {
        q.FONTDATA.FONTS[m][F][2] -= 100;
        q.FONTDATA.FONTS[m][F][5] = { rfix: -100 };
      }
    }
  );
