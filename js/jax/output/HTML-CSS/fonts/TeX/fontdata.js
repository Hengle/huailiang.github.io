...
(function(i, b, q) {
  ...
  i.Augment({
    FONTDATA: {
      ...
      VARIANT: {
        ...
        'double-struck': { fonts: [h, m] },
        fraktur: { fonts: ['MathJax_Fraktur', m, g, h] },
        'bold-fraktur': {
          fonts: ['MathJax_Fraktur-bold', r, g, h],
          bold: true
        },
        script: { fonts: ['MathJax_Script', m, g, h] },
        'bold-script': { fonts: ['MathJax_Script', r, g, h], bold: true },
        'sans-serif': { fonts: ['MathJax_SansSerif', m, g, h] },
        'bold-sans-serif': {
        ...
        monospace: { fonts: ['MathJax_Typewriter', m, g, h] },
        '-tex-caligraphic': {
      ...
      RemapPlane1: function(v, u) {
        ...
        return { n: v, variant: u };
      },
      DELIMITERS: {
        40: {
          dir: a,
          HW: [[1, m], [1.2, g], [1.8, f], [2.4, e], [3, c]],
        ...
        47: { dir: a, HW: [[1, m], [1.2, g], [1.8, f], [2.4, e], [3, c]] },
        91: {
          dir: a,
          HW: [[1, m], [1.2, g], [1.8, f], [2.4, e], [3, c]],
          stretch: { top: [9121, c], ext: [9122, c], bot: [9123, c] }
        },
        92: { dir: a, HW: [[1, m], [1.2, g], [1.8, f], [2.4, e], [3, c]] },
        93: {
          dir: a,
          HW: [[1, m], [1.2, g], [1.8, f], [2.4, e], [3, c]],
        ...
        124: { dir: a, HW: [[1, m]], stretch: { ext: [8739, m] } },
        125: {
          dir: a,
          HW: [[1, m], [1.2, g], [1.8, f], [2.4, e], [3, c]],
          stretch: {
        ...
        8722: { dir: j, HW: [[0.5, m, 0, 8211]], stretch: { rep: k } },
        8730: {
          dir: a,
          HW: [[1, m], [1.2, g], [1.8, f], [2.4, e], [3, c]],
          stretch: {
        ...
        8739: { dir: a, HW: [[1, m]], stretch: { ext: [8739, m] } },
        8741: { dir: a, HW: [[1, m]], stretch: { ext: [8741, m] } },
        8968: {
          dir: a,
          HW: [[1, m], [1.2, g], [1.8, f], [2.4, e], [3, c]],
          stretch: { top: [9121, c], ext: [9122, c] }
        },
        8969: {
          dir: a,
          HW: [[1, m], [1.2, g], [1.8, f], [2.4, e], [3, c]],
          stretch: { top: [9124, c], ext: [9125, c] }
        },
        8970: {
          dir: a,
          HW: [[1, m], [1.2, g], [1.8, f], [2.4, e], [3, c]],
          stretch: { ext: [9122, c], bot: [9123, c] }
        },
        8971: {
          dir: a,
          HW: [[1, m], [1.2, g], [1.8, f], [2.4, e], [3, c]],
          stretch: { ext: [9125, c], bot: [9126, c] }
        },
        9130: {
          dir: a,
          HW: [[0.32, c]],
        ...
        10216: { dir: a, HW: [[1, m], [1.2, g], [1.8, f], [2.4, e], [3, c]] },
        10217: { dir: a, HW: [[1, m], [1.2, g], [1.8, f], [2.4, e], [3, c]] },
        10222: {
          dir: a,
          HW: [[0.989, m]],
  ...
  i.Font.loadComplete = function(u, v, t, s) {
    ...
    if (u.family === g || u.family === f) {
      if (u.version === 1) {
        i.FONTDATA.VARIANT['-largeOp'].remap = { 8898: 8899, 8899: 8898 };
        i.FONTDATA.VARIANT['-smallOp'].remap = { 8898: 8899, 8899: 8898 };
      }
    }
  };
  ...
  i.FONTDATA.FONTS[m][8773][5] = { rfix: -222 };
  MathJax.Hub.Register.LoadHook(
    i.fontDir + '/Main/Bold/MathOperators.js',
    function() {
      i.FONTDATA.FONTS[r][8773][2] -= 106;
      i.FONTDATA.FONTS[r][8773][5] = { rfix: -106 };
    }
  );
  MathJax.Hub.Register.LoadHook(
    i.fontDir + '/Typewriter/Regular/BasicLatin.js',
    function() {
      i.FONTDATA.FONTS.MathJax_Typewriter[32][2] += 275;
      i.FONTDATA.FONTS.MathJax_Typewriter[32][5] = { rfix: 275 };
    }
  );
  MathJax.Hub.Register.LoadHook(
    i.fontDir + '/Typewriter/Regular/Other.js',
    function() {
      i.FONTDATA.FONTS.MathJax_Typewriter[160][2] += 275;
      i.FONTDATA.FONTS.MathJax_Typewriter[160][5] = { rfix: 275 };
    }
  );
    ...
    MathJax.Hub.Browser.Select({
      MSIE: function(u) {
        if (i.config.availableFonts && i.config.availableFonts.length) {
          ...
          if (i.Font.testFont({ family: 'MathJax_Greek', testString: t })) {
            i.Augment({
              FONTDATA: {
                VARIANT: {
                  normal: { offsetIEG: 913, variantIEG: '-Greek' },
                  fraktur: { offsetIEG: 913, variantIEG: '-Greek' },
                  script: { offsetIEG: 913, variantIEG: '-Greek' },
                  '-tex-caligraphic': { offsetIEG: 913, variantIEG: '-Greek' },
                  '-tex-oldstyle': { offsetIEG: 913, variantIEG: '-Greek' },
          ...
          if (
            ...
            i.Augment({
              FONTDATA: {
                VARIANT: {
                  bold: { offsetIEG: 913, variantIEG: '-Greek-Bold' },
                  'bold-fraktur': { offsetIEG: 913, variantIEG: '-Greek-Bold' },
                  'bold-script': { offsetIEG: 913, variantIEG: '-Greek-Bold' },
          ...
          if (
            ...
            i.Augment({
              FONTDATA: {
                VARIANT: {
                  italic: { offsetIEG: 913, variantIEG: '-Greek-Italic' },
        ...
        if (i.msieIE6) {
          ...
          var s = { offsetAR: 57856, variantAR: '-WinIE6', remap: v };
          var x = { offsetAR: 57920, variantAR: '-WinIE6', remap: y };
          i.Augment({
            FONTDATA: {
              VARIANT: {
                normal: s,
                ...
                '-largeOp': {
                  fonts: [w, f, g, m],
                  remap: { 8719: 58000, 8721: 58001, 8747: 58005, 8750: 58006 }
                },
                '-smallOp': {
                  fonts: [w, g, m],
                  remap: { 8719: 57984, 8721: 57985, 8747: 57989, 8750: 57990 }
                },
                '-WinIE6': { fonts: [w] }
              },
              DELIMITERS: {
                ...
                8592: {
                  HW: { 0: [0.889, w, null, 57856] },
                  stretch: { left: [57856, w] }
                },
                8593: {
                  HW: { 0: [0.888, w, null, 57857] },
                  stretch: { top: [57991, w], ext: [57993, w] }
                },
                8594: {
                  HW: { 0: [0.889, w, null, 57858] },
                  stretch: { right: [57858, w] }
                },
                8595: {
                  HW: { 0: [0.888, w, null, 57859] },
                  stretch: { bot: [57992, w], ext: [57993, w] }
                },
                8596: {
                  HW: { 0: [1, w, null, 57860] },
                  stretch: { left: [57856, w], right: [57858, w] }
                },
                8597: {
                  HW: { 0: [1.044, w, null, 57859] },
                  stretch: { top: [57991, w], bot: [57992, w], ext: [57993, w] }
                }
              }
            }
          });
      ...
      Chrome: function(t) {
        ...
        if (t.isPC && !MathJax.Hub.Browser.versionAtLeast('5.0')) {
          ...
          i.Augment({
            FONTDATA: {
              VARIANT: {
                normal: { remap: { 62: [62, s] } },
                bold: { remap: { 58097: [62, s] } },
                italic: { remap: { 100: [100, s] } },
                '-tex-caligraphic': { remap: { 84: [84, s] } },
                '-tex-caligraphic-bold': { remap: { 84: [58096, s] } },
                '-largeOp': { remap: { 10752: [10752, s] } },
                '-smallOp': { remap: { 8899: [8899, s] } },
                '-WinChrome': { fonts: ['MathJax_WinChrome'] }
              },
              DELIMITERS: {
                93: { stretch: { bot: [9126, 'MathJax_WinChrome'] } },
                8971: { stretch: { bot: [9126, 'MathJax_WinChrome'] } }
              }
            }
          });
