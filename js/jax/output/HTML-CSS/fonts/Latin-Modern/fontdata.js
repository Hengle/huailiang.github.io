...
(function(r, f, E) {
  ...
  r.Augment({
    FONTDATA: {
      ...
      VARIANT: {
        normal: { fonts: [w, t, F, i, c, o, x, D, v, b, y, p, A, n] },
        bold: {
          fonts: [w, t, F, i, c, o, x, D, v, b, y, p, A, n],
          bold: true,
          offsetA: 119808,
          offsetG: 120488,
          offsetN: 120782
        ...
        '-Latin-Modern-variant': {
          fonts: [p, w, t, F, i, c, o, x, D, v, b, y, A, n]
        },
        '-tex-caligraphic': {
          fonts: [w, t, F, i, c, o, x, D, v, b, y, p, A, n],
          italic: true
        },
        '-tex-oldstyle': { fonts: [w, t, F, i, c, o, x, D, v, b, y, p, A, n] },
      ...
      DELIMITERS: {
        ...
        773: {
          dir: s,
          HW: [[0.392, o], [0.568, n]],
          stretch: { left: [57595, e], rep: [57596, e], right: [57597, e] }
        },
        774: u,
        780: {
          dir: s,
        ...
        8722: {
          dir: s,
          HW: [],
          stretch: { rep: [8722, w, 0, 0, 0, -0.31, -0.31] }
        },
        8725: { alias: 8260, dir: d },
        8730: {
          dir: d,
          HW: [[1, w], [1.2, n], [1.8, m], [2.4, l], [3, j]],
        ...
        9130: { dir: d, HW: [[0.748, v]], stretch: { ext: [9130, v] } },
  ...
  MathJax.Hub.Register.LoadHook(
    r.fontDir + '/Main/Regular/Main.js',
    function() {
      r.FONTDATA.FONTS[w][8722][0] = r.FONTDATA.FONTS[w][43][0];
      r.FONTDATA.FONTS[w][8722][1] = r.FONTDATA.FONTS[w][43][1];
    }
  );
  MathJax.Hub.Register.LoadHook(
    r.fontDir + '/Size7/Regular/Main.js',
    function() {
      var G;
      G = r.FONTDATA.DELIMITERS[9182].stretch.rep[0];
      r.FONTDATA.FONTS[e][G][0] += 200;
      r.FONTDATA.FONTS[e][G][1] += 200;
      G = r.FONTDATA.DELIMITERS[9183].stretch.rep[0];
      r.FONTDATA.FONTS[e][G][0] += 200;
      r.FONTDATA.FONTS[e][G][1] += 200;
    }
  );
  MathJax.Hub.Register.LoadHook(
    r.fontDir + '/Size1/Regular/Main.js',
    function() {
      r.FONTDATA.FONTS[n][8747][2] -= 425;
      r.FONTDATA.FONTS[n][8747][5] = { rfix: -425 };
      r.FONTDATA.FONTS[n][8748][2] -= 425;
      r.FONTDATA.FONTS[n][8748][5] = { rfix: -425 };
      r.FONTDATA.FONTS[n][8749][2] -= 425;
      r.FONTDATA.FONTS[n][8749][5] = { rfix: -425 };
      r.FONTDATA.FONTS[n][8750][2] -= 425;
      r.FONTDATA.FONTS[n][8750][5] = { rfix: -425 };
      r.FONTDATA.FONTS[n][8751][2] -= 425;
      r.FONTDATA.FONTS[n][8751][5] = { rfix: -425 };
      r.FONTDATA.FONTS[n][8752][2] -= 425;
      r.FONTDATA.FONTS[n][8752][5] = { rfix: -425 };
      r.FONTDATA.FONTS[n][8753][2] -= 425;
      r.FONTDATA.FONTS[n][8753][5] = { rfix: -425 };
      r.FONTDATA.FONTS[n][8754][2] -= 425;
      r.FONTDATA.FONTS[n][8754][5] = { rfix: -425 };
      r.FONTDATA.FONTS[n][8755][2] -= 425;
      r.FONTDATA.FONTS[n][8755][5] = { rfix: -425 };
      r.FONTDATA.FONTS[n][10764][2] -= 425;
      r.FONTDATA.FONTS[n][10764][5] = { rfix: -425 };
      r.FONTDATA.FONTS[n][10769][2] -= 425;
      r.FONTDATA.FONTS[n][10769][5] = { rfix: -425 };
    }
  );
  E.loadComplete(r.fontDir + '/fontdata.js');
