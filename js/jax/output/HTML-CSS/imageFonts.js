    ...
    HTMLCSS.Augment({
      ...
      handleImg: function (span, font, c, n, text) {
        ...
        if (index == this.imgEmWidth.length - 1 &&
          this.em * span.scale * bscale / this.imgEmWidth[index] > 1.1) { bscale = this.imgEmWidth[index] / (this.em * span.scale) }
      ...
      initImg: function (span) {
        ...
        for (var i = 0, m = this.imgEmWidth.length - 1; i < m; i++) { if (this.em <= this.imgEmWidth[i]) break }
      ...
      imgIndex: function (scale) {
        ...
        for (var i = 0, m = this.imgEmWidth.length - 1; i < m; i++) { if (em <= this.imgEmWidth[i]) break }
