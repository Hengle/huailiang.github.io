...
(function(a, c, r) {
  ...
  var p = a.config.undefinedFamily;
  MathJax.Hub.Insert(a.config.styles, {
    '.MJXc-TeX-unknown-R': {
      'font-family': p,
      'font-style': 'normal',
      'font-weight': 'normal'
  ...
  a.FONTDEF.TeX = {
    ...
    VARIANT: {
      normal: {
        ...
        remap: {
          ...
          57696: [8594, '-TeX-vec'],
          8214: 8741,
          8726: [8726, '-TeX-variant', true],
          8463: [8463, '-TeX-variant', true],
          8242: [39, 'sans-serif-italic'],
          10744: [47, c.VARIANT.ITALIC]
        }
      },
      bold: {
        fonts: [s],
      ...
      'double-struck': { fonts: [i, m, h], cache: {} },
      fraktur: { fonts: ['MathJax_Fraktur'], cache: {}, chain: 'normal' },
      'bold-fraktur': {
        fonts: ['MathJax_Fraktur-Bold'],
        bold: true,
        cache: {},
        chain: 'bold'
      },
      ...
      'bold-script': {
        fonts: ['MathJax_Script'],
        bold: true,
        cache: {},
        chain: 'bold'
      },
      'sans-serif': {
        fonts: ['MathJax_SansSerif'],
        cache: {},
        chain: 'normal'
      },
      'bold-sans-serif': {
        fonts: ['MathJax_SansSerif-Bold'],
        bold: true,
        cache: {},
        chain: 'bold'
      },
      'sans-serif-italic': {
        fonts: ['MathJax_SansSerif-Italic'],
        italic: true,
        cache: {},
        chain: 'italic'
      },
      ...
      '-TeX-variant': {
        ...
        remap: {
          ...
          988: 57352,
          1008: 57353,
          8726: [8726, c.VARIANT.NORMAL, true],
          8463: [8463, c.VARIANT.NORMAL, true]
        }
      },
      '-TeX-vec': { fonts: ['MathJax_Vector'], cache: {} },
      '-TeX-vec-bold': { fonts: ['MathJax_Vector-Bold'], cache: {} },
      '-largeOp': { fonts: [g, h, m, i], cache: {} },
      '-smallOp': { fonts: [h, m, i], cache: {} },
      '-tex-caligraphic-bold': {
        fonts: ['MathJax_Caligraphic-Bold', 'MathJax_Main-Bold'],
        bold: true,
        cache: {},
        chain: 'normal',
        offsetA: 65,
    ...
    REMAP: {
      ...
      9723: 9633,
      9724: 9632,
      8450: [67, c.VARIANT.DOUBLESTRUCK],
      8459: [72, c.VARIANT.SCRIPT],
      8460: [72, c.VARIANT.FRAKTUR],
      8461: [72, c.VARIANT.DOUBLESTRUCK],
      8462: [104, c.VARIANT.ITALIC],
      8464: [74, c.VARIANT.SCRIPT],
      8465: [73, c.VARIANT.FRAKTUR],
      8466: [76, c.VARIANT.SCRIPT],
      8469: [78, c.VARIANT.DOUBLESTRUCK],
      8473: [80, c.VARIANT.DOUBLESTRUCK],
      8474: [81, c.VARIANT.DOUBLESTRUCK],
      8475: [82, c.VARIANT.SCRIPT],
      8476: [82, c.VARIANT.FRAKTUR],
      8477: [82, c.VARIANT.DOUBLESTRUCK],
      8484: [90, c.VARIANT.DOUBLESTRUCK],
      8486: [937, c.VARIANT.NORMAL],
      8488: [90, c.VARIANT.FRAKTUR],
      8492: [66, c.VARIANT.SCRIPT],
      8493: [67, c.VARIANT.FRAKTUR],
      8496: [69, c.VARIANT.SCRIPT],
      8497: [70, c.VARIANT.SCRIPT],
      8499: [77, c.VARIANT.SCRIPT],
      8775: 8774,
      8988: 9484,
      8989: 9488,
      8990: 9492,
    ...
    RemapPlane1: function(w, v) {
      for (var u = 0, t = this.PLANE1MAP.length; u < t; u++) {
        if (w < this.PLANE1MAP[u][0]) {
          break;
        }
        if (w <= this.PLANE1MAP[u][1]) {
          w = w - this.PLANE1MAP[u][0] + this.PLANE1MAP[u][2];
          if (this.REMAPGREEK[w]) {
            w = this.REMAPGREEK[w];
          }
          v = this.VARIANT[this.PLANE1MAP[u][3]];
          break;
        }
      }
      return { n: w, variant: v };
    },
    DELIMITERS: {
      40: {
        dir: b,
        HW: [[1, m], [1.2, h], [1.8, g], [2.4, f], [3, d]],
        stretch: { top: [9115, d], ext: [9116, d], bot: [9117, d] }
      },
      41: {
        dir: b,
        HW: [[1, m], [1.2, h], [1.8, g], [2.4, f], [3, d]],
        stretch: { top: [9118, d], ext: [9119, d], bot: [9120, d] }
      },
      47: { dir: b, HW: [[1, m], [1.2, h], [1.8, g], [2.4, f], [3, d]] },
      91: {
        dir: b,
        HW: [[1, m], [1.2, h], [1.8, g], [2.4, f], [3, d]],
        stretch: { top: [9121, d], ext: [9122, d], bot: [9123, d] }
      },
      92: { dir: b, HW: [[1, m], [1.2, h], [1.8, g], [2.4, f], [3, d]] },
      93: {
        dir: b,
        HW: [[1, m], [1.2, h], [1.8, g], [2.4, f], [3, d]],
        stretch: { top: [9124, d], ext: [9125, d], bot: [9126, d] }
      },
      123: {
        dir: b,
        HW: [[1, m], [1.2, h], [1.8, g], [2.4, f], [3, d]],
      ...
      124: { dir: b, HW: [[1, m]], stretch: { ext: [8739, m] } },
      125: {
        dir: b,
        HW: [[1, m], [1.2, h], [1.8, g], [2.4, f], [3, d]],
        stretch: {
      ...
      175: { dir: j, HW: [[0.59, m]], stretch: { rep: [175, m] } },
      710: {
        dir: j,
        HW: [
          [0.267 + 0.25, m],
      ...
      8211: { dir: j, HW: [[0.5, m]], stretch: { rep: [8211, m] } },
      8214: {
        dir: b,
        HW: [[0.602, h], [1, m, null, 8741]],
        stretch: { ext: [8741, m] }
      },
      8592: { dir: j, HW: [[1, m]], stretch: { left: [8592, m], rep: k } },
      8593: {
        dir: b,
        HW: [[0.888, m]],
        stretch: { top: [8593, h], ext: [9168, h] }
      },
      8594: { dir: j, HW: [[1, m]], stretch: { rep: k, right: [8594, m] } },
      8595: {
        dir: b,
        HW: [[0.888, m]],
        stretch: { ext: [9168, h], bot: [8595, h] }
      },
      8596: {
        dir: j,
        HW: [[1, m]],
      ...
      8597: {
        dir: b,
        HW: [[1.044, m]],
        stretch: { top: [8593, h], ext: [9168, h], bot: [8595, h] }
      },
      8656: { dir: j, HW: [[1, m]], stretch: { left: [8656, m], rep: n } },
      8657: {
        dir: b,
        HW: [[0.888, m]],
        stretch: { top: [8657, h], ext: [8214, h] }
      },
      8658: { dir: j, HW: [[1, m]], stretch: { rep: n, right: [8658, m] } },
      8659: {
        dir: b,
        HW: [[0.888, m]],
        stretch: { ext: [8214, h], bot: [8659, h] }
      },
      8660: {
        dir: j,
        HW: [[1, m]],
        stretch: { left: [8656, m], rep: n, right: [8658, m] }
      },
      8661: {
        dir: b,
        HW: [[1.044, m]],
        stretch: { top: [8657, h], ext: [8214, h], bot: [8659, h] }
      },
      8722: { dir: j, HW: [[0.778, m]], stretch: { rep: [8722, m] } },
      8730: {
        dir: b,
        HW: [[1, m], [1.2, h], [1.8, g], [2.4, f], [3, d]],
        stretch: {
      ...
      8739: { dir: b, HW: [[1, m]], stretch: { ext: [8739, m] } },
      8741: { dir: b, HW: [[1, m]], stretch: { ext: [8741, m] } },
      8968: {
        dir: b,
        HW: [[1, m], [1.2, h], [1.8, g], [2.4, f], [3, d]],
        stretch: { top: [9121, d], ext: [9122, d] }
      },
      8969: {
        dir: b,
        HW: [[1, m], [1.2, h], [1.8, g], [2.4, f], [3, d]],
        stretch: { top: [9124, d], ext: [9125, d] }
      },
      8970: {
        dir: b,
        HW: [[1, m], [1.2, h], [1.8, g], [2.4, f], [3, d]],
        stretch: { ext: [9122, d], bot: [9123, d] }
      },
      8971: {
        dir: b,
        HW: [[1, m], [1.2, h], [1.8, g], [2.4, f], [3, d]],
        stretch: { ext: [9125, d], bot: [9126, d] }
      },
      9130: {
        dir: b,
        HW: [[0.32, d]],
        stretch: { top: [9130, d], ext: [9130, d], bot: [9130, d] }
      },
      9136: {
        dir: b,
        HW: [[0.989, m]],
        stretch: { top: [9127, d], ext: [9130, d], bot: [9133, d] }
      },
      9137: {
        dir: b,
        HW: [[0.989, m]],
        stretch: { top: [9131, d], ext: [9130, d], bot: [9129, d] }
      },
      9168: {
        dir: b,
        HW: [[0.602, h], [1, m, null, 8739]],
        stretch: { ext: [8739, m] }
      },
      9182: {
        dir: j,
      ...
      10216: { dir: b, HW: [[1, m], [1.2, h], [1.8, g], [2.4, f], [3, d]] },
      10217: { dir: b, HW: [[1, m], [1.2, h], [1.8, g], [2.4, f], [3, d]] },
      10222: {
        dir: b,
        HW: [[0.989, m]],
        stretch: { top: [9127, d], ext: [9130, d], bot: [9129, d] }
      },
      10223: {
        dir: b,
        HW: [[0.989, m]],
        stretch: { top: [9131, d], ext: [9130, d], bot: [9133, d] }
      },
      45: { alias: 8722, dir: j },
      94: { alias: 710, dir: j },
      95: { alias: 8211, dir: j },
      ...
      771: { alias: 732, dir: j },
      780: { alias: 711, dir: j },
      818: { alias: 8211, dir: j },
      8212: { alias: 8211, dir: j },
      8213: { alias: 8211, dir: j },
      8215: { alias: 8211, dir: j },
      8254: { alias: 175, dir: j },
      8407: { alias: 8594, dir: j },
      8725: { alias: 47, dir: b },
      9001: { alias: 10216, dir: b },
      9002: { alias: 10217, dir: b },
      9135: { alias: 8211, dir: j },
      9472: { alias: 8211, dir: j },
      10072: { alias: 8739, dir: b },
      12296: { alias: 10216, dir: b },
      12297: { alias: 10217, dir: b },
      65079: { alias: 9182, dir: j },
      65080: { alias: 9183, dir: j },
      61: l,
      8606: l,
      8608: l,
      8612: l,
      ...
      10592: e,
      10593: e,
      8978: { alias: 9180, dir: j },
      8994: { alias: 9180, dir: j },
      8995: { alias: 9181, dir: j },
      10229: { alias: 8592, dir: j },
      10230: { alias: 8594, dir: j },
      10231: { alias: 8596, dir: j },
      10232: { alias: 8656, dir: j },
      10233: { alias: 8658, dir: j },
      10234: { alias: 8660, dir: j },
      10235: { alias: 8612, dir: j },
      10236: { alias: 8614, dir: j },
      10237: { alias: 10502, dir: j },
      10238: { alias: 10503, dir: j },
      57696: { alias: 8592, dir: j }
    }
  };
  a.FONTDATA = a.FONTDEF.TeX;
  a.FONTDATA.FONTS.MathJax_Caligraphic = {
    centerline: 287,
    ascent: 789,
    descent: 216,
    skew: {
  ...
  a.FONTDATA.FONTS['MathJax_Main-Bold'] = {
    centerline: 342,
    ascent: 951,
    descent: 267,
    weight: 'bold',
  ...
  a.FONTDATA.FONTS['MathJax_Main-Italic'] = {
    centerline: 250,
    ascent: 750,
    descent: 250,
    style: 'italic',
  ...
  a.FONTDATA.FONTS['MathJax_Math-Italic'] = {
    centerline: 250,
    ascent: 717,
    descent: 218,
    style: 'italic',
  ...
  a.FONTDATA.FONTS.MathJax_Size1 = {
    centerline: 250,
    ascent: 850,
    descent: 350,
    32: [0, 0, 250, 0, 0],
  ...
  a.FONTDATA.FONTS.MathJax_Size2 = {
    centerline: 249,
    ascent: 1360,
    descent: 862,
    32: [0, 0, 250, 0, 0],
  ...
  a.FONTDATA.FONTS.MathJax_Size3 = {
    centerline: 250,
    ascent: 1450,
    descent: 950,
    32: [0, 0, 250, 0, 0],
  ...
  a.FONTDATA.FONTS.MathJax_Size4 = {
    centerline: 250,
    ascent: 1750,
    descent: 1250,
    32: [0, 0, 250, 0, 0],
  ...
  a.FONTDATA.FONTS.MathJax_Vector = {
    centerline: 257,
    ascent: 714,
    descent: 200,
    8594: [714, -516, 500, 29, 471]
  };
  a.FONTDATA.FONTS['MathJax_Vector-Bold'] = {
    centerline: 256,
    ascent: 723,
    descent: 210,
    8594: [723, -513, 575, 33, 542]
  };
  a.FONTDATA.FONTS[m][8722][0] = a.FONTDATA.FONTS[m][43][0];
  a.FONTDATA.FONTS[m][8722][1] = a.FONTDATA.FONTS[m][43][1];
  a.FONTDATA.FONTS[m][8942][0] += 400;
  a.FONTDATA.FONTS[m][8945][0] += 700;
  a.FONTDATA.FONTS[d][9130][0] -= 20;
  a.FONTDATA.FONTS[d][9130][1] += 5;
  a.FONTDATA.FONTS[d][57684][0] += 200;
  a.FONTDATA.FONTS[d][57684][1] += 200;
  a.FONTDATA.FONTS[m][8773][2] -= 222;
  a.FONTDATA.FONTS[m][8773][5] = { rfix: -222 };
  MathJax.Hub.Register.LoadHook(a.fontDir + '/TeX/Main-Bold.js', function() {
    a.FONTDATA.FONTS[s][8773][2] -= 106;
    a.FONTDATA.FONTS[s][8773][5] = { rfix: -106 };
  });
  MathJax.Hub.Register.LoadHook(
    a.fontDir + '/TeX/Typewriter-Regular.js',
    function() {
      a.FONTDATA.FONTS.MathJax_Typewriter[32][2] += 275;
      a.FONTDATA.FONTS.MathJax_Typewriter[32][5] = { rfix: 275 };
      a.FONTDATA.FONTS.MathJax_Typewriter[160][2] += 275;
      a.FONTDATA.FONTS.MathJax_Typewriter[160][5] = { rfix: 275 };
    }
  );
  MathJax.Hub.Insert(a.FONTDATA.FONTS[m], {
    remapCombining: {
      768: 715,
      769: 714,
      770: 710,
    ...
    8202: [0, 0, 100, 0, 0, { space: 1 }],
    8203: [0, 0, 0, 0, 0, { space: 1 }],
    8204: [0, 0, 0, 0, 0, { space: 1 }],
    8289: [0, 0, 0, 0, 0, { space: 1 }],
    8290: [0, 0, 0, 0, 0, { space: 1 }],
    8291: [0, 0, 0, 0, 0, { space: 1 }],
    8292: [0, 0, 0, 0, 0, { space: 1 }],
    61152: [0, 0, -575, 0, 0, { space: 1 }],
    61153: [0, 0, -300, 0, 0, { space: 1 }],
    61160: [0, 0, 25, 0, 0, { space: 1 }]
  });
  MathJax.Hub.Insert(a.FONTDATA.FONTS['MathJax_Main-Italic'], {
    remapCombining: {
      768: [715, m],
      769: [714, m],
      770: [710, m],
      ...
      778: [730, m],
      780: [711, m],
      824: [47, 'MathJax_Vector']
    }
  });
  MathJax.Hub.Insert(a.FONTDATA.FONTS['MathJax_Main-Bold'], {
    remapCombining: {
      768: 715,
      769: 714,
      770: 710,
      ...
      778: 730,
      780: 711,
      824: [47, 'MathJax_Math-BoldItalic'],
      8407: [8594, 'MathJax_Vector-Bold']
    }
  });
  a.FONTDATA.familyName = function(t) {
    t = t.replace(/^MathJax_/, '');
    var v = (t + '-Regular').split(/-/);
    var u =
      v[0].toLowerCase().replace(/(?:igraphic|serif|writer|tur|tor)$/, '') +
      '-' +
      v[1].replace(/[^A-Z]/g, '');
    return 'MJXc-TeX-' + u;
  };
  (function() {
    var C = a.config.styles,
      z = a.FONTDATA.FONTS;
    var B = r.fileURL(a.webfontDir + '/TeX/otf'),
      t = r.fileURL(a.webfontDir + '/TeX/eot'),
      D = r.fileURL(a.webfontDir + '/TeX/woff');
    var x = [];
    for (var u in z) {
      if (z.hasOwnProperty(u)) {
        var A = a.FONTDATA.familyName(u),
          v = A;
        var y = (u + '-Regular').split(/-/)[1];
        z[u].className = A;
        var w = { 'font-family': A };
        u = u.replace(/-.*/, '');
        if (y === 'Regular') {
          w.src = "local('" + u + "'), local('" + u + "-Regular')";
        } else {
          w.src = "local('" + u + ' ' + y + "'), local('" + u + '-' + y + "')";
        }
        x.push(w);
        if (y !== 'Regular') {
          w = { 'font-family': A + 'x', src: "local('" + u + "')" };
          if (y.match(/Bold/)) {
            w['font-weight'] = 'bold';
          }
          if (y.match(/Italic/)) {
